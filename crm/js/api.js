...
const API={
  ...
  async getAll(){const out={};for(const s of Object.values(CONFIG.SHEETS))out[s]=await this.get(s);return {usuarios:(out.USUARIOS||[]).map(normalizeUser),clientes:out.CLIENTES||[],negociacoes:(out.NEGOCIACOES||[]).map(normalizeDeal),interacoes:out.INTERACOES||[],tarefas:out.TAREFAS||[],propostas:out.PROPOSTAS||[],historico:out.HISTORICO||[],configuracoes:out.CONFIGURACOES||[],logs:out.LOGS||[]}},
