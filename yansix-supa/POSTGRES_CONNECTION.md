...
Depois crie o respectivo registro na tabela `usuários`, com o mesmo e-mail e perfil `Administrador`.

Não adicione senha na tabela `usuários`: a senha pertence ao Supabase Auth.
