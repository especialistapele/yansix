...
const CONFIG={
  ...
  DB_TABLES:{LOGS:"logs",USUARIOS:"usuários",CLIENTES:"clientes",NEGOCIACOES:"negociações",INTERACOES:"interações",TAREFAS:"tarefas",PROPOSTAS:"propostas",HISTORICO:"histórico",CONFIGURACOES:"configurações"},
  PIPELINE_STAGES:[
