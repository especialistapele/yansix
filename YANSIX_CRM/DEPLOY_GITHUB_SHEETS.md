...
5. Confirme as abas: `USUARIOS`, `CLIENTES`, `NEGOCIACOES`, `INTERACOES`, `TAREFAS`, `PROPOSTAS`, `HISTORICO`, `CONFIGURACOES`, `LOGS`.
6. O administrador inicial é `yansix.tech@gmail.com` com a senha uma senha definida exclusivamente nas Script Properties. A senha é gravada como SHA-256.
